...
def get_fitbit_data():
    df1 = pd.read_csv('cleaned2018-06-27_through_2018-07-27.csv', nrows=31)
    df2 = pd.read_csv('cleaned_2018-04-26_through_2018-05-26.csv', nrows=31)
    df3 = pd.read_csv('cleaned_2018-05-27_through_2018-06-26.csv', nrows=31)
    df4 = pd.read_csv('cleaned_2018-07-28_through_2018-08-26.csv', nrows=30)
    df5 = pd.read_csv('cleaned_2018-08-27_through_2018-09-26.csv', nrows=31)
    df6 = pd.read_csv('cleaned_2018-09-27_through_2018-10-27.csv', nrows=31)
    df7 = pd.read_csv('cleaned_2018-10-28_through-2018-11-27.csv', nrows=31)
    df8 = pd.read_csv('cleaned_2018-11-28_through_2018-12-28.csv', nrows=9)
